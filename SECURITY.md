...
steps to reproduce. Please do not open a public issue for security reports.
You can expect an initial response within a few days.

## Supported versions

The latest published minor version receives fixes. Pre-1.0 releases may
introduce breaking changes in minor versions, as allowed by semantic versioning.
